...
<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>小区业主管理 <span class="c-gray en">&gt;</span>
新增小区业主 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="users/createUsers.action" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<article class="page-container">
<form class="form form-horizontal" id="form-article-add" action="users/addUsers.action" name="myform" method="post">
...
<div class="row cl"><label class="form-label col-xs-4 col-sm-2">身份证号</label><div class="formControls col-xs-8 col-sm-9"><input type="text" name="idcard" class="input-text" id="idcard" placeholder="请输入身份证号" /></div></div>
...
<div class="row cl"><label class="form-label col-xs-4 col-sm-2">住宅地址</label><div class="formControls col-xs-8 col-sm-9"><input type="text" name="address" class="input-text" id="address" placeholder="请输入住宅地址" /></div></div>
